...
from occupancy_grid_map.rrt.rrt_utils.heuristics import cost_to_go, segment_cost, path_cost
...
class RRTStar(RRT):
    ...
    def rewire(self, tree, x_new, L_near):
        ...
        for c_near, x_near in L_near:
            ...
            if tent_cost < curr_cost and self.X.collision_free(x_near, x_new):
